...
export const equipmentSchema = z.object({
  ...
  serialNumber: z.string().max(100, "Maksimal 100 karakter").optional(),
  ...
  ccEmail: z.string().email("Format email tidak valid").optional().or(z.literal("")),
  condition: z.string().max(50, "Maksimal 50 karakter").optional(),
  usageStatus: z.string().max(50, "Maksimal 50 karakter").optional(),
  ownerUnit: z.string().max(150, "Maksimal 150 karakter").optional(),
  ...
  calibrationType: z.string().max(50, "Maksimal 50 karakter").optional(),
  calibrationInterval: z.string().max(50, "Maksimal 50 karakter").optional(),
  measurementRange: z.string().max(150, "Maksimal 150 karakter").optional(),
