        ...
        {submitted ? (
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-slate-500">
              Jika email <strong>{email}</strong> terdaftar sebagai akun Admin, kami sudah
              mengirimkan tautan untuk membuat password baru. Tautan berlaku selama 60 menit.
            </p>
            <Link href="/login" className="inline-flex items-center gap-1.5 text-sm text-accent hover:text-accent-light">
          ...
          <>
            ...
            <p className="text-sm text-slate-500 mb-6">
              Masukkan email akun Admin Anda, kami akan kirimkan tautan reset password.
            </p>
