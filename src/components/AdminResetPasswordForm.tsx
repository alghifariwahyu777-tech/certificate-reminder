...
export function AdminResetPasswordForm() {
  ...
  return (
    <>
      ...
      <p className="text-sm text-slate-500 mb-6">Masukkan password baru untuk akun Admin Anda.</p>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <Label htmlFor="admin-reset-new-password">Password Baru</Label>
          <Input
        ...
        <div>
          <Label htmlFor="admin-reset-confirm-password">Konfirmasi Password</Label>
          <Input
